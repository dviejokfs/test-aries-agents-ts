...
import { AgentDependencies, AgentMessage, InitConfig, OutOfBandInvitation } from '@aries-framework/core'
...
process.env.BASE_PATH = path.join(`${process.cwd()}/agent2`)
...
const agentConfig: InitConfig = {
    endpoints,
    label: process.env.AGENT_LABEL || 'Aries Framework JavaScript Mediator Agent2',
    walletConfig: {
        id: process.env.WALLET_NAME || 'AriesFrameworkJavaScript Agent2',
        key: process.env.WALLET_KEY || 'AriesFrameworkJavaScript Agent2',
    },
